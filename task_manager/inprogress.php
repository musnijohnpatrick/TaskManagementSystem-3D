...
$tasks = $conn->query("SELECT * FROM tasks WHERE assigned_to=$user_id AND status='In Progress'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="sidebar">
  ...
  <div class="content">
    <h2>🚧 In Progress Tasks - <?php echo $_SESSION['user']['username']; ?></h2>
    <hr>
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <?php }} else { ?>
          <tr><td colspan="4" class="text-center text-muted">No in-progress tasks.</td></tr>
        <?php } ?>
      </tbody>
    </table>
  </div>
